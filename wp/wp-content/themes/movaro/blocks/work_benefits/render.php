...
$work_benefits = get_field("benefits_work") ?? [];
?>

<section class="b-work-benefits container wide">

    <svg class = "b-work-benefits__bg" xmlns="http://www.w3.org/2000/svg" width="556" height="709" viewBox="0 0 556 709" fill="none">
        <path d="M556 320.798L498.344 446.18L339.678 790L185.035 485.499H0L153.302 147.359L257.44 -82L367.389 319.05L555.106 320.798H556Z" fill="#FFD338" fill-opacity="0.1" />
    </svg>
    ...
    <div class="b-work-benefits__content">
        <?php if ($work_benefits): ?>
            <?php foreach ($work_benefits as $benefit): ?>
                <div class="b-work-benefits__card">
                    <div class="b-work-benefits__card-icon">
                        <?php if ($benefit['icon']): ?>
                    ...
                    <div class="b-work-benefits__card-desc">
    ...
    <footer class="b-work-benefits__footer">
        <a href="#" class="b-work-benefits__footer-button button--full">
