...
$label_button1 = get_field("label_button_1") ?? "";
$url_button1 = get_field("url_button_1") ?? "";
$photo1 = get_field("photo_1");
?>

<section class="b-cta container">
    <div class="b-cta__shadow">
        <svg xmlns="http://www.w3.org/2000/svg" width="390" height="462" viewBox="0 0 390 462" fill="none">
            <g filter="url(#filter0_f_24_14)">
                <path d="M190 233.82L154.95 310.027L58.4952 519L-35.5145 333.925H-148L-54.8055 128.404L8.50162 -11L75.3408 232.758L189.457 233.82H190Z" fill="#FFD338" fill-opacity="0.4" />
            </g>
            <defs>
                <filter id="filter0_f_24_14" x="-348" y="-211" width="738" height="930" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix" />
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                    <feGaussianBlur stdDeviation="100" result="effect1_foregroundBlur_24_14" />
                </filter>
            </defs>
        </svg>
    </div>
    <div class="b-cta__shadow-top">
        <svg xmlns="http://www.w3.org/2000/svg" width="485" height="350" viewBox="0 0 485 350" fill="none">
            <g filter="url(#filter0_f_24_26)">
                <path d="M469 -135.18L433.95 -58.9729L337.495 150L243.486 -35.0751H131L224.195 -240.596L287.502 -380L354.341 -136.242L468.457 -135.18H469Z" fill="#FFD338" fill-opacity="0.56" />
            </g>
            <defs>
                <filter id="filter0_f_24_26" x="-69" y="-580" width="738" height="930" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                    <feFlood flood-opacity="0" result="BackgroundImageFix" />
                    <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                    <feGaussianBlur stdDeviation="100" result="effect1_foregroundBlur_24_26" />
                </filter>
            </defs>
        </svg>
    </div>
    <div class="b-cta__content">
        ...
        <a href="<?= $url_button1 ?>" class="b-hero__cta-button button--full">
            ...
            <span><?= htmlspecialchars($label_button1) ?></span>
        </a>
    </div>
    <div class="b-cta__photo">
        <?php if ($photo1): ?>
