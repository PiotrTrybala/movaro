...
$url_header_1 = get_field("url_header_1") ?? '';
...
<section class="container b-benefits">
    <div class="b-benefits__content">
        ...
        <div class="b-benefits__content-cta">
            <a href="<?= esc_url($url_header_1) ?>" class="b-benefits__heading-cta-button button--full">
                ...
                <span><?= esc_html($label_button1) ?></span>
            </a>
        </div>
    </div>

    <div class="b-benefits__gallery">
        <?php if ($benefits): ?>
            <?php foreach ($benefits as $benefit): ?>
                <div class="b-benefits__card">
                    <div class="b-benefits__card-icon">
                        <?php if ($benefit['icon']): ?>
                            <?php $icon = $benefit['icon']; ?>
                            <?= wp_get_attachment_image($icon['ID'], 'thumbnail') ?>
                        <?php endif; ?>
                    </div>
                    <h3><?= esc_html($benefit['header'] ?? '') ?></h3>
                    <div class="b-benefits__card-desc">
